...
import com.example.ratingsoft.databinding.ActivityDetailEventBinding
...
class DetailEvent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnParticipar.setOnClickListener {
            ...
            if (buttonPressed) {
                binding.btnParticipar.setBackgroundColor(ContextCompat.getColor(this, R.color.common_google_signin_btn_text_dark))
    ...
    private fun setupUI(
        ...
        if (imagen != null && imagen.toString() != "") {
            ...
            Picasso.get().load(R.drawable.googleg_disabled_color_18).into(imageViewEvent)
            progressBar.visibility = View.GONE
        }
    }
    ...
    private fun updateButtonUI() {
        if (buttonPressed) {
            binding.btnParticipar.setBackgroundColor(ContextCompat.getColor(this, R.color.secondary_text_default_material_light))
            binding.btnParticipar.setText("Asistiré")
        } else {
            binding.btnParticipar.setBackgroundColor(ContextCompat.getColor(this, R.color.notification_icon_bg_color))
            binding.btnParticipar.setText("No Asistiré")
        }
    }
    ...
    private fun saveButtonStateLocal(buttonPressed: Boolean, eventName: String) {
        val prefs =
            getSharedPreferences(getString(R.string.common_signin_button_text), MODE_PRIVATE).edit()
    ...
    private fun loadButtonStateLocal(eventName: String): Boolean {
        ...
        val prefs = getSharedPreferences(getString(R.string.common_open_on_phone), MODE_PRIVATE)
